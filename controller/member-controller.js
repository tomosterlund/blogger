                ...
                .then(userDocument => {
                    ...
                    userDocument.save()
                        .then(() => {
                            ...
                            Post.updateMany(
                                { postId: userParam },
                                {"$set": { postAuthor: updatedName, authorImage: updatedImage.filename || userDocument.imageUrl }}
                            )
                            .then(() => {
                                Reply.updateMany(
                                    { replyAuthorId: userParam },
                                    { "$set": { replyAuthorName: updatedName, replyAuthorImage: updatedImage.filename || userDocument.imageUrl } }
                                )
                                .then(() => {
